        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="md:flex md:flex-grow">
            <ul className="flex flex-grow justify-end flex-wrap items-center">
              <li>
                <a href="/learning" className="px-3 lg:px-5 py-2 flex items-center transition duration-150 ease-in-out">Learning</a>
              </li>
              <li>
                <a href="/blog" className="px-3 lg:px-5 py-2 flex items-center transition duration-150 ease-in-out">Blog</a>
              </li>
              <li>
                <a href="/about" className="px-3 lg:px-5 py-2 flex items-center transition duration-150 ease-in-out">About</a>
              </li>
            </ul>
          </nav>
        </div>
