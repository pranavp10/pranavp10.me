        ...
        <div className="flex flex-col justify-center items-start max-w-2xl mx-auto mb-16">
          <div className="max-w-3xl pb-8 md:pb-16 text-center md:text-left">
            ...
            <p className="text-gray-600 dark:text-gray-100 my-4">
              I will be Sharing all the hard things I come across which will be sharing all my
              research done on that so that i will be easy for others to implement.
            </p>
