...
const Blog = ({ posts }) => {
  ...
  return (
    <>
      <SEO
        BaseTitle="JavaScript | Pranav"
        slug="/javascript"
        description="I will be Sharing all the hard things I come across which will be sharing all my research done on that so that i will be easy for others to implement."
      />
      <div className="pt-32">
        <div className="flex flex-col justify-center items-start max-w-2xl mx-auto mb-16">
          <div className="max-w-3xl pb-8 md:pb-16 text-center md:text-left">
            <h1 className="text-5xl font-black">JavaScript</h1>
            <p className="text-gray-600 dark:text-gray-100 my-4">
              Learning how the JavaScript works under the hood and understanding the concept.
            </p>
          ...
          {filteredBlogPosts.map((frontMatter) => (
            <BlogPost
              ...
              {...frontMatter}
              slug={`javascript/${frontMatter.slug}`}
            />
          ))}
        </div>
      </div>
